...
from agents.RegretMinimizationAgent import RegretMinimizationAgent
...
class Runner(object):
    def __init__(
        ...
        self.agents = [
            RegretMinimizationAgent(0, batch_size),
            RegretMinimizationAgent(1, batch_size),
        ]
    ...
    def run(self):
        for _ in range(self.num_runs):
            ...
            for episode in range(self.num_episodes):
                ...
                if episode % 10 == 0:
                    print("Episode: {}, Reward: {}".format(episode, self.evaluate()))
